      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div className="text-xs text-blue-600 mt-0.5 leading-relaxed">
            Downloads NSE bhavcopy and extracts {symbol ? `${symbol}'s` : ""} option chain (all expiries) for the date range below. Data is stored locally so it loads instantly after.
            {" "}This range is independent of the From Date / To Date fields above — it only controls how much option-chain data gets downloaded, not how far back the backtest itself runs.
          </div>
        </div>
      </div>
